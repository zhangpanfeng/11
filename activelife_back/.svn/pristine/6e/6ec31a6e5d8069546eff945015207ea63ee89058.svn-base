...
data-options="formatter:myformatter,parser:myparser"></input></td>
                    ...
                    <tr>
                        ...
                        <td><input type="button" value="查询" onclick="serach()" class="easyui-linkbutton"
					iconCls="ext-icon-search"/></td>
                    </tr>
                </table>
            </form>
        </div>
                    ...
                    <tbody>
                        <c:forEach items="${customerList}" var="customer">
                            <tr>
                                ...
                                <td class="align_left">${customer.firstName}${customer.secondName}</td>
                                ...
                                <td class="align_left">${customer.gender}</td>
                                <td class="align_left">${customer.companyName}</td>
